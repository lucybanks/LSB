...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210504_lucindastuartbanks_2fbd9f13fd91bed17397_20210504183452_archive.zip';
	const ARCHIVE_SIZE		 = '88545017';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2fbd9f1-04183452';
    const SECONDARY_PACKAGE_HASH = 'a0a8315-04183452';
	const VERSION			 = '1.4.0';
